...
!0).fadeIn("fast");a.ajax({url:templateDir+"/proxy.php?url=http://forums.darkfallonline.com/external.php?type=RSS2",dataType:"xml",async:!1,type:"GET",timeout:6E4,success:function(c){var b="<ul>";a(c).find("item").each(function(c){if(4<c)return!1;b+='<li><a href="'+a(this).find("link").text()+'" target="_blank" rel="nofollow"><span class="title">'+e(a(this).find("title").text())+'</span></a> <div class="descr">'+e(a(this).find("description").text())+"</div></li>"});b+="</ul>";a(".bottom .forumfeed ul").length&&
...
"/serverstatus.php",dataType:"json",timeout:6E4,success:function(c){a("#server-status").find("span i").removeClass("up down");for(var b in c)c.hasOwnProperty(b)&&a("#server-status").find("."+b).find("i").addClass(c[b])},error:function(){a("#server-status").find("span i").removeClass("up down")}});setTimeout(function(){f.getStatus()},12E4)}},j={init:function(){a(".your-subject").change(function(){"Add My Clan"==a(".your-subject option:selected").val()?(a(".feedback .clan-details").slideDown(),a(".feedback .event-details").slideUp()):
...
(a("#holding-btn").removeClass("active"),showHoldings=!1,hideMarkers("holdings")):(a("#holding-btn").addClass("active"),showHoldings=!0,showMarkers("holdings"))});a("#village-btn").click(function(){showVillages?(a("#village-btn").removeClass("active"),showVillages=!1,hideMarkers("villages")):(a("#village-btn").addClass("active"),showVillages=!0,showMarkers("villages"))})}},l={init:function(){a(".video h2, .video p").ellipsis()}},g="fuck;shit;fag; ass;puss;nigg;bitch;asshole;dick;penis;vagina".split(";");
