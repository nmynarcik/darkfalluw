...
showHoldings=!0,showMarkers("holdings"))});a("#village-btn").click(function(){showVillages?(a("#village-btn").removeClass("active"),showVillages=!1,hideMarkers("villages")):(a("#village-btn").addClass("active"),showVillages=!0,showMarkers("villages"))});a("#searchmap").click(function(){searchPOIs(a("#mapsearch-text").val())})}},l={init:function(){a(".video h2, .video p").ellipsis()}},g="fuck;shit;fag; ass;puss;nigg;bitch;asshole;dick;penis;vagina;cunt".split(";");a(".post-type-archive-role, .post-type-archive-school, .post-type-archive-spell, .single-school").length&&
h.init();a(".page-template-archive-video-php").length&&l.init();a("h2").length&&a("h2").ellipsis();a(".home").length&&d.init();a(".clans").length&&i.init();a(".feedback").length&&j.init();a("#branding").length&&f.getStatus();a("#map_canvas").length&&(map_initialize(),k.init());a(".misc-game-info").length&&a("table").tablesorter({widgets:["zebra"]});0==a(".gad").height()&&(a(".gad").addClass("blocked"),a("#wrapper > .gad, article > .gad").append('<a href="http://www.gamefanshop.com/partner-IamRedSeal/" target="_blank"><img src="http://www.gamefanshop.com/StoreFiles/Styles/vip/banner1.jpg" alt="gamefanshop partner banner" /></a>'),
a("#sidebar > .gad").append('<a href="http://www.gamefanshop.com/partner-IamRedSeal/" target="_blank"><img src="http://www.gamefanshop.com/StoreFiles/Styles/vip/banner2t.jpg" width="180" alt="gamefanshop partner banner" /></a>'))})(jQuery);
