...
h.init();a(".page-template-archive-video-php").length&&l.init();a("h2").length&&a("h2").ellipsis();a(".home").length&&d.init();a(".clans").length&&i.init();a(".feedback").length&&j.init();a("#branding").length&&f.getStatus();a("#map_canvas").length&&(map_initialize(),k.init());a(".misc-game-info").length&&a("table").tablesorter({widgets:["zebra"]});0==a(".gad").height()&&(a("body").prepend('<div id="anti-ads">You are currently disabling ads. To help support this site, please consider allowing ads to show.<i class="icon-remove icon-white"></i></div>'),
setTimeout(function(){a("#anti-ads").slideDown()},5E3),a("#anti-ads").bind("click",function(){a(this).slideUp()}))})(jQuery);
