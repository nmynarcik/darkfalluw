...
a(".bottom .forumfeed ul").remove();a(".bottom .forumfeed").append(b);console.log(b);a(".load-wrapper").stop(!0,!0).fadeOut();a(".bottom .blogfeed a, .bottom .eventfeed a, .forumfeed li a, .forumfeed li .descr").ellipsis();setTimeout(function(){d.getForumFallFeed()},18E4)},error:function(){a(".loading, .loader").stop(!0,!0).fadeOut();setTimeout(function(){d.getForumFallFeed()},18E4)}})}},f={getStatus:function(){a.ajax({url:templateDir+"/serverstatus.php",dataType:"json",success:function(c){a("#server-status").find("span i").removeClass("up down");
...
showHoldings=!0,showMarkers("holdings"))})}},l={init:function(){a(".video h2, .video p").ellipsis()}},g="fuck;shit;fag; ass;puss;nigg;bitch;asshole;dick;penis;vagina".split(";");a(".post-type-archive-role, .post-type-archive-school, .post-type-archive-spell, .single-school").length&&h.init();a(".page-template-archive-video-php").length&&l.init();a("h2").length&&a("h2").ellipsis();a(".home").length&&d.init();a(".clans").length&&i.init();a(".feedback").length&&j.init();a("#branding").length&&f.getStatus();
a("#map_canvas").length&&(map_initialize(),k.init());a(".misc-game-info").length&&a("table").tablesorter({widgets:["zebra"]})})(jQuery);
