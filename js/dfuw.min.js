...
18E4)}})}},f={getStatus:function(){a.ajax({url:templateDir+"/serverstatus.php",dataType:"json",timeout:6E4,success:function(c){if("SUCCESS"==c["@attributes"].Result){a("#server-status").find("span i").removeClass("up down");for(var c=c.Servers.ServerStatus,b=0;b<c.length;b++){console.log(c[b]["@attributes"]);var d=c[b]["@attributes"].ID.toLowerCase();a("#server-status").find("."+d).find("i").addClass(c[b]["@attributes"].Status.toLowerCase())}}},error:function(){a("#server-status").find("span i").removeClass("up down")}});
setTimeout(function(){f.getStatus()},12E4)}},j={init:function(){a(".your-subject").change(function(){"Add My Clan"==a(".your-subject option:selected").val()?(a(".feedback .clan-details").slideDown(),a(".feedback .event-details").slideUp()):"Add My Event"==a(".your-subject option:selected").val()?(a(".feedback .clan-details").slideUp(),a(".feedback .event-details").slideDown()):(a(".feedback .clan-details").slideUp(),a(".feedback .event-details").slideUp())})}},k={init:function(){a("#fs-btn").click(function(){fullscreen?
(a("#map-container").appendTo(".entry-content"),a("#fs-btn").removeClass("active"),fullscreen=!1):(a("#map-container").appendTo("body"),a("#fs-btn").addClass("active"),a("body").scrollTop(0),fullscreen=!0);map_initialize();checkToggles();marker&&marker.setMap(map)});a("#mob-btn").click(function(){showMobs?(a("#mob-btn").removeClass("active"),showMobs=!1,hideMarkers("mobs")):(a("#mob-btn").addClass("active"),showMobs=!0,showMarkers("mobs"))});a("#bank-btn").click(function(){showBanks?(a("#bank-btn").removeClass("active"),
showBanks=!1,hideMarkers("banks")):(a("#bank-btn").addClass("active"),showBanks=!0,showMarkers("banks"))});a("#chest-btn").click(function(){showBanks?(a("#chest-btn").removeClass("active"),showBanks=!1,hideMarkers("chests")):(a("#chest-btn").addClass("active"),showBanks=!0,showMarkers("chests"))});a("#craft-btn").click(function(){showCrafts?(a("#craft-btn").removeClass("active"),showCrafts=!1,hideMarkers("crafts")):(a("#craft-btn").addClass("active"),showCrafts=!0,showMarkers("crafts"))});a("#bind-btn").click(function(){showBinds?
...
showHoldings=!0,showMarkers("holdings"))});a("#village-btn").click(function(){showVillages?(a("#village-btn").removeClass("active"),showVillages=!1,hideMarkers("villages")):(a("#village-btn").addClass("active"),showVillages=!0,showMarkers("villages"))});a("#searchmap").click(function(){console.log(a("#mapsearch-text").val());searchPOIs(a("#mapsearch-text").val())})}},l={init:function(){a(".video h2, .video p").ellipsis()}},g="fuck;shit;fag; ass;puss;nigg;bitch;asshole;dick;penis;vagina;cunt".split(";");
