...
RegExp(this.value+"\\s(.*)\\s?\\b"+b("#select-two").val(),"gi");this.value===b("#select-two").val()&&(a=RegExp("^"+this.value+"$","i"));for(var c=0;c<crafter.filteredList.length;c++)crafter.filteredList[c].Name.match(a)&&crafter.showItem(crafter.filteredList[c])}})})(jQuery);RegExp.escape=function(b){return b.replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&")};function isEmpty(b){return 0===Object.keys(b).length};
