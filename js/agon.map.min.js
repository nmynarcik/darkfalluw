...
(e=e.split("|"));var d='<ul class="poi-info">';if(null!=e&&0<e.length)for(var g=0;g<e.length;g++)d=d+"<li>"+e[g]+"</li>";else d=d+"<li>"+e+"</li>";d=d+'</ul><a href="http://www.darkfallunholywars.info/?p='+poiArray[c].pid+'" class="icon icon-comment" target="_blank" title="Discuss Loot">Loot Table</a><a href="http://www.darkfallunholywars.info/wp-admin/post.php?post='+poiArray[c].pid+'&action=edit" class="icon icon-cog" target="_blank" title="Edit POI">Edit POI</a>';f=new google.maps.LatLng(f[0],
f[1]);d=new google.maps.Marker({position:f,map:null,icon:a,html:d});google.maps.event.addListener(d,"click",function(){copyToClipboard(this)});google.maps.event.addListener(d,"mouseover",function(){infowindow.setContent(this.html);infowindow.open(map,this)});b.push(d)}}
