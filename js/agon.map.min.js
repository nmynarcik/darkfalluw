...
function searchPOIs(b){if(""===b)alert("Please enter something to search."),$("#mapsearch-text").focus();else if(3>b.length)alert("Please enter atleast 3 characters to perform search.");else{for(var a=0;a<searchResults.length;a++)searchResults[a].setMap(null);searchArray=[];for(a=0;a<poiArray.length;a++)null!=poiArray[a].title&&null!=poiArray[a].title.toLowerCase().match(b.toLowerCase())&&searchArray.push(poiArray[a]);showSearchResults(searchArray)}}
