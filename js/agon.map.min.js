...
a=binds;break;case "sbind":b=templateDir+"/images/poi-bind-safe.png";a=binds;break;case "craft":b=templateDir+"/images/poi-craft.png";a=crafts;break;case "portal":b=templateDir+"/images/poi-portal.png";a=portals;break;case "pchamber":b=templateDir+"/images/poi-chamber.png",a=portals}var d=poiArray[c]._poi_loc.split("|"),d=new google.maps.LatLng(d[0],d[1]),e=new google.maps.Marker({position:d,map:null,icon:b,title:poiArray[c].title});google.maps.event.addListener(e,"click",function(){copyToClipboard(e)});
a.push(e)}}function showMarkers(a){var b;switch(a){case "mobs":b=mobs;break;case "banks":b=banks;break;case "crafts":b=crafts;break;case "binds":b=binds;break;case "portals":b=portals;break;case "holdings":b=holdings}for(var a=new google.maps.LatLngBounds,c=0;c<b.length;c++)b[c].setMap(map),a.extend(b[c].getPosition()),map.fitBounds(a)}
