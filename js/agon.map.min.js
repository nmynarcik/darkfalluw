...
var map,CustomMapType=new CustomMapType,fullscreen=!1,showMobs=!1,showBanks=!1,showCrafts=!1,showBinds=!1,showPortals=!1,showHoldings=!1,mobs=[],banks=[],binds=[],crafts=[],portals=[],chambers=[],holdings=[];
...
function createMarkers(){for(var a=null,b,c=0;c<poiArray.length;c++){switch(poiArray[c]._poi_type){case "bank":b=templateDir+"/images/poi-bank.png";a=banks;break;case "mob":b=""==poiArray[c]._poi_level?templateDir+"/images/poi-mob.png":templateDir+"/images/poi-mob-"+poiArray[c]._poi_level+".png";a=mobs;break;case "city":b=templateDir+"/images/poi-city.png";a=holdings;break;case "hamlet":b=templateDir+"/images/poi-hamlet.png";a=holdings;break;case "bindstones":b=templateDir+"/images/poi-bind.png";
a=binds;break;case "craft":b=templateDir+"/images/poi-craft.png";a=crafts;break;case "portal":b=templateDir+"/images/poi-portal.png";a=portals;break;case "pchamber":b=templateDir+"/images/poi-chamber.png",a=portals}var d=poiArray[c]._poi_loc.split("|"),d=new google.maps.LatLng(d[0],d[1]),e=new google.maps.Marker({position:d,map:null,icon:b,title:poiArray[c].title});google.maps.event.addListener(e,"click",function(){copyToClipboard(e)});a.push(e)}}
function showMarkers(a){var b;switch(a){case "mobs":b=mobs;break;case "banks":b=banks;break;case "crafts":b=crafts;break;case "binds":b=binds;break;case "portals":b=portals;break;case "holdings":b=holdings}for(var a=new google.maps.LatLngBounds,c=0;c<b.length;c++)b[c].setMap(map),a.extend(b[c].getPosition()),map.fitBounds(a)}
function hideMarkers(a){var b;switch(a){case "mobs":b=mobs;break;case "banks":b=banks;break;case "crafts":b=crafts;break;case "binds":b=binds;break;case "portals":b=portals;break;case "holdings":b=holdings}for(a=0;a<b.length;a++)b[a].setMap(null)}
function checkToggles(){jQuery.each(jQuery("#map-legend a"),function(){if(jQuery(this).hasClass("active"))switch(jQuery(this).attr("id")){case "mob-btn":showMarkers("mobs");break;case "bank-btn":showMarkers("banks");break;case "craft-btn":showMarkers("crafts");break;case "bind-btn":showMarkers("binds");break;case "portal-btn":showMarkers("portals");break;case "holding-btn":showMarkers("holdings")}})};
