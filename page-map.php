...
<?php the_content(); ?>
<a href="http://www.geckzilla.com/dfstuff/dfmap.swf" class="btn btn-inverse pop-out top" onclick="javascript:void window.open('http://www.geckzilla.com/dfstuff/dfmap.swf','1354867021522','width=1248,height=1024,toolbar=0,menubar=0,location=0,status=0,scrollbars=0,resizable=1,left=0,top=0');return false;">Popout <i class="icon-fullscreen icon-white"></i></a>
  <iframe id="geck-map" src="http://www.geckzilla.com/dfstuff/dfmap.swf" width="695" height="695" ></iframe>
